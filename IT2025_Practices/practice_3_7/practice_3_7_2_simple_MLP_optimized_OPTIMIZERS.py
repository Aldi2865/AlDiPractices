...
from tensorflow.keras.optimizers import SGD # Додано для використання Adam оптимізатора
from tensorflow.keras.optimizers import RMSprop # Додано для використання Adam оптимізатора
